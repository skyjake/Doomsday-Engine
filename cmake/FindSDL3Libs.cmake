...
macro (target_link_sdl3 target vis)
    if (UNIX AND NOT APPLE)
        if (TARGET SDL3::SDL3-static)
            target_link_libraries (${target} ${vis} SDL3::SDL3-static)
        endif ()
        if (TARGET SDL3_mixer::SDL3_mixer-static)
            target_link_libraries (${target} ${vis} SDL3_mixer::SDL3_mixer-static)
        endif ()
    else ()
        if (TARGET SDL3::SDL3)
            #if (MINGW)
            ...
            #endif ()
            target_link_libraries (${target} ${vis} SDL3::SDL3)
        endif ()
        if (TARGET SDL3_mixer::SDL3_mixer)
            target_link_libraries (${target} ${vis} SDL3_mixer::SDL3_mixer)
        endif ()
    endif ()
endmacro ()

macro (deng_bundle_sdl3 target)
    if (APPLE)
        deng_install_bundle_deps (${target} SDL3::SDL3)
        if (TARGET SDL3_mixer::SDL3_mixer)
            deng_install_bundle_deps (${target} SDL3_mixer::SDL3_mixer)
        endif ()
    endif ()
endmacro ()
...
# if (PKG_CONFIG_FOUND AND NOT (MSYS OR MINGW OR CYGWIN OR IOS))
...
#            message (FATAL_ERROR "SDL2_DIR must be set in MSYS/Cygwin/MinGW")
#        endif ()
#        # Assume it has been set manually.
#        if (MSVC)
#             set (SDL2_LIBRARY ${sdlRoot}/lib/${DE_ARCH}/SDL2.lib)
#        else ()
#             set (SDL2_LIBRARY ${sdlRoot}/lib/${DE_ARCH}/SDL2.dll)
#        endif ()
#     else ()
...
#         else ()
#             set (SDL2_MIXER_LIBRARY ${sdlMixerDir}/lib/${DE_ARCH}/SDL2_mixer.dll)
#         endif ()
#     else ()
...
if (NOT TARGET SDL3_mixer::SDL3_mixer)
    ...
    message (STATUS "SDL3_mixer disabled (not found).")
endif ()
