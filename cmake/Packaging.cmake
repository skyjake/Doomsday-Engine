...
set (CPACK_PACKAGE_DESCRIPTION_FILE ${DE_SOURCE_DIR}/scripts/debian/description.txt)
...
set (CPACK_RPM_PACKAGE_REQUIRES "qt5-qtbase-gui >= 5.2, qt5-qtx11extras >= 5.2, SDL3 >= 3.0, SDL3_mixer >= 3.0, libXrandr, libXxf86vm, libxcb, glib2, zlib, ncurses-libs")
if (NOT DE_FLUIDSYNTH_EMBEDDED)
...
if (APPLE)
    ...
    set (CPACK_DMG_BACKGROUND_IMAGE "${DE_SOURCE_DIR}/scripts/macx/dmg_background.jpg")
...
elseif (UNIX)
    ...
    set (CPACK_WIX_UI_DIALOG "${DE_SOURCE_DIR}/scripts/win32/installer_dialog.png")
    set (CPACK_WIX_UI_BANNER "${DE_SOURCE_DIR}/scripts/win32/installer_banner.png")
endif ()
