...
#ifdef __JDOOM__
#  include "../jDoom/doomtype.h"
#  include "../jDoom/doomdef.h"
#  include "../jDoom/r_data.h" // Needed because we are refering to patches.
#elif __JHERETIC__
#  include "../jHeretic/doomdef.h"  // Needed because we are refering to patches.
#  include "../Common/hu_stuff.h"
#elif __JHEXEN__
#  include "../jHexen/h2def.h"
#  include "../Common/hu_stuff.h"	// Needed because we are refering to patches.
#elif __JSTRIFE__
...
//
// $Log$
// Revision 1.1  2005/05/29 05:16:31  danij
// Commonised.
//
// Revision 1.5  2005/03/02 00:00:02  DaniJ
