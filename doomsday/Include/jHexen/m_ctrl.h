...
static const MenuItem_t ControlsItems[] = {
	...
	{ITT_EFUNC, "WEAPON 1 :", SCControlConfig, A_WEAPON1},
	{ITT_EFUNC, "WEAPON 2 :", SCControlConfig, A_WEAPON2},
	{ITT_EFUNC, "WEAPON 3 :", SCControlConfig, A_WEAPON3},
	{ITT_EFUNC, "WEAPON 4 :", SCControlConfig, A_WEAPON4},
	...
	{ITT_EFUNC, "MYSTIC URN :", SCControlConfig, A_MYSTICURN},
	{ITT_EFUNC, "KRATER OF MIGHT :", SCControlConfig, A_KRATER},
	{ITT_EFUNC, "BOOTS OF SPEED :", SCControlConfig, A_SPEEDBOOTS},
	{ITT_EFUNC, "REPULSION :", SCControlConfig, A_BLASTRADIUS},
	{ITT_EFUNC, "CHAOS DEVICE :", SCControlConfig, A_TELEPORT},
	{ITT_EFUNC, "BANISHMENT :", SCControlConfig, A_TELEPORTOTHER},
	{ITT_EFUNC, "BOOTS OF SPEED :", SCControlConfig, A_SPEEDBOOTS},
	{ITT_EFUNC, "FLECHETTE :", SCControlConfig, A_POISONBAG},
	{ITT_EFUNC, "DEFENDER :", SCControlConfig, A_INVULNERABILITY},
	{ITT_EFUNC, "DARK SERVANT :", SCControlConfig, A_DARKSERVANT},
	{ITT_EFUNC, "PORKELATOR :", SCControlConfig, A_EGG},
	{ITT_EMPTY, NULL, NULL, 0},
	{ITT_EMPTY, "INVENTORY", NULL, 0},
	{ITT_EFUNC, "INVENTORY LEFT :", SCControlConfig, 52},
	{ITT_EFUNC, "INVENTORY RIGHT :", SCControlConfig, 53},
	{ITT_EFUNC, "USE ARTIFACT :", SCControlConfig, A_USEARTIFACT},
	{ITT_EMPTY, NULL, NULL, 0},
	{ITT_EMPTY, "MENU HOTKEYS", NULL, 0},
	{ITT_EFUNC, "INFO :", SCControlConfig, 40},
	{ITT_EFUNC, "SOUND MENU :", SCControlConfig, 43},
	{ITT_EFUNC, "LOAD GAME :", SCControlConfig, 41},
	{ITT_EFUNC, "SAVE GAME :", SCControlConfig, 42},
	{ITT_EFUNC, "QUICK LOAD :", SCControlConfig, 48},
	{ITT_EFUNC, "QUICK SAVE :", SCControlConfig, 45},
	{ITT_EFUNC, "SUICIDE :", SCControlConfig, 44},
	{ITT_EFUNC, "END GAME :", SCControlConfig, 46},
	{ITT_EFUNC, "QUIT :", SCControlConfig, 49},
	{ITT_EFUNC, "MESSAGES ON/OFF:", SCControlConfig, 47},
	{ITT_EFUNC, "GAMMA CORRECTION :", SCControlConfig, 50},
	{ITT_EFUNC, "SPY MODE :", SCControlConfig, 51},
	{ITT_EMPTY, NULL, NULL, 0},
	{ITT_EMPTY, "SCREEN", NULL, 0},
	{ITT_EFUNC, "SMALLER VIEW :", SCControlConfig, 55},
	{ITT_EFUNC, "LARGER VIEW :", SCControlConfig, 54},
	{ITT_EFUNC, "SMALLER ST. BAR :", SCControlConfig, 57},
	{ITT_EFUNC, "LARGER ST. BAR :", SCControlConfig, 56},
	{ITT_EMPTY, NULL, NULL, 0},
	{ITT_EMPTY, "AUTOMAP KEYS", NULL, 0},
	{ITT_EFUNC, "OPEN/COSE MAP :", SCControlConfig, 60},
	{ITT_EFUNC, "PAN UP :", SCControlConfig, 69},
	{ITT_EFUNC, "PAN DOWN :", SCControlConfig, 70},
	{ITT_EFUNC, "PAN LEFT :", SCControlConfig, 71},
	{ITT_EFUNC, "PAN RIGHT :", SCControlConfig, 72},
	{ITT_EFUNC, "FOLLOW MODE :", SCControlConfig, 61},
	{ITT_EFUNC, "ROTATE MODE :", SCControlConfig, 62},
	{ITT_EFUNC, "TOGGLE GRID :", SCControlConfig, 63},
	{ITT_EFUNC, "ZOOM IN :", SCControlConfig, 64},
	{ITT_EFUNC, "ZOOM OUT :", SCControlConfig, 65},
	{ITT_EFUNC, "ZOOM EXTENTS :", SCControlConfig, 66},
	{ITT_EFUNC, "ADD MARK :", SCControlConfig, 67},
	{ITT_EFUNC, "CLEAR MARKS :", SCControlConfig, 68},
	{ITT_EMPTY, NULL, NULL,  0},
	{ITT_EMPTY, "MISCELLANEOUS", NULL, 0},
	{ITT_EFUNC, "STOP DEMO :", SCControlConfig, A_STOPDEMO},
	{ITT_EFUNC, "PAUSE :", SCControlConfig, 58},
	{ITT_EFUNC, "CHAT :", SCControlConfig, 73},
	{ITT_EFUNC, "GREEN CHAT :", SCControlConfig, 74},
	{ITT_EFUNC, "YELLOW CHAT :", SCControlConfig, 75},
