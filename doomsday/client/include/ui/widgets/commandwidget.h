...
#ifndef DENG_CLIENT_COMMANDWIDGET_H
#define DENG_CLIENT_COMMANDWIDGET_H
 ...
 * @ingroup gui
 */
class CommandWidget : public LineEditWidget
{
    Q_OBJECT

public:
    CommandWidget(de::String const &name = "");
...
protected:
     ...
     */
    virtual bool isAcceptedAsCommand(de::String const &text) = 0;

    virtual void executeCommand(de::String const &text) = 0;
     ...
     */
    void showAutocompletionPopup(de::String const &completionsText);
...
#endif // DENG_CLIENT_COMMANDWIDGET_H
