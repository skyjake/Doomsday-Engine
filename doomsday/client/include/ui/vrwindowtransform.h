...
#ifndef DENG_CLIENT_UI_VRWINDOWTRANSFORM_H
#define DENG_CLIENT_UI_VRWINDOWTRANSFORM_H
...
{
public:
    VRWindowTransform(ClientWindow &window);
...
#endif // DENG_CLIENT_UI_VRWINDOWTRANSFORM_H
