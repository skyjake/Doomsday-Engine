...
DENG2_PIMPL(LogWidget)
{
    ...
    struct CacheEntry {
        ...
        CacheEntry() : id(Id::None), height(0), rasterized(0) {}
    };
    ...
    void prune()
    {
        ...
        {
            CacheEntry entry = cache.takeFirst();
            atlas.release(entry.id);
            delete entry.rasterized;
        }
    }
...
/*
    ...
    */
    ...
    int const maxScroll = d->maxVisibleOffset(pos.height());
    /*
