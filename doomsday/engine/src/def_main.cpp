...
static int generateMaterialDefForCompositeTexture(de::TextureMetaFile &metafile, void * /*parameters*/)
{
    LOG_AS("generateMaterialDefForCompositeTexture");

    de::Uri texUri = metafile.composeUri();
...
static int generateMaterialDefForFlatTexture(de::TextureMetaFile &metafile, void * /*parameters*/)
{
...
static int generateMaterialDefForSpriteTexture(de::TextureMetaFile &metafile, void * /*parameters*/)
{
