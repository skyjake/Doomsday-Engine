...
/**
 * sys_window.c: X11-based window management.
 *
 * This code wraps X11 window management routines in order to provide
 ...
 * platform-specific code to make best use of features and UI particulars
 * of this platform.
 */
