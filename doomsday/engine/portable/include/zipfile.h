 ...
 */
size_t ZipFile_ReadLump2(zipfile_t* zip, lumpnum_t lumpNum, uint8_t* buffer, boolean tryCache);
size_t ZipFile_ReadLump(zipfile_t* zip, lumpnum_t lumpNum, uint8_t* buffer);
 ...
 * @return  Number of bytes read.
 */
size_t ZipFile_ReadLumpSection2(zipfile_t* zip, lumpnum_t lumpNum, uint8_t* buffer,
    size_t startOffset, size_t length, boolean tryCache);
size_t ZipFile_ReadLumpSection(zipfile_t* zip, lumpnum_t lumpNum, uint8_t* buffer,
 ...
 */
const uint8_t* ZipFile_CacheLump(zipfile_t* zip, lumpnum_t lumpNum, int tag);
