...
void        DS_DummySet(sfxbuffer_t* buf, int prop, float value);
void        DS_DummySetv(sfxbuffer_t* buf, int prop, float* values);
void        DS_DummyListener(int prop, float value);
void        DS_DummyListenerv(int prop, float* values);
