...
void Sv_GetInfo(serverinfo_t* info)
{
    ...
    strncpy(info->gameIdentityKey, Str_Text(GameInfo_IdentityKey(DD_CurrentGameInfo())), sizeof(info->gameIdentityKey) - 1);
    ...
    */
    ...
    case PCL_HELLO2:
        ...
        if(netBuffer.msg.type == PCL_HELLO2)
        {
            ...
            if(strnicmp(buf, Str_Text(GameInfo_IdentityKey(DD_CurrentGameInfo())), 16))
            {
