...
ui_object_t ob_panel[] =
{
    ...
    { UI_TEXT,      0,  0,              300, 375, 0, 55,    "Shadow darkness factor", UIText_Drawer },
    { UI_SLIDER,    0,  0,              680, 375, 300, 55,  "",         UISlider_Drawer, UISlider_Responder, UISlider_Ticker, CP_CvarSlider, &sld_shadow_dark },
    { UI_TEXT,      0,  0,              300, 435, 0, 55,    "Shadow visible distance", UIText_Drawer },
    { UI_SLIDER,    0,  0,              680, 435, 300, 55,  "",         UISlider_Drawer, UISlider_Responder, UISlider_Ticker, CP_CvarSlider, &sld_shadow_far },
    { UI_TEXT,      0,  0,              300, 495, 0, 55,    "Maximum shadow radius", UIText_Drawer },
    { UI_SLIDER,    0,  0,              680, 495, 300, 55,  "",         UISlider_Drawer, UISlider_Responder, UISlider_Ticker, CP_CvarSlider, &sld_shadow_radmax },
    ...
    { UI_TEXT,      0,  0,              300, 615, 0, 55,    "Radiosity shadow darkness", UIText_Drawer },
    { UI_SLIDER,    0,  0,              680, 615, 300, 55,  "",         UISlider_Drawer, UISlider_Responder, UISlider_Ticker, CP_CvarSlider, &sld_fakeradio_dark },
