...
static int generateMaterialDefForPatchCompositeTexture(texture_t* tex, void* paramaters)
{
    ...
    if(pcTex)
    {
        ...
        texUri = Textures_ComposeUri(tex);
        mat->uri = Uri_NewWithPath2(Str_Text(Uri_Path(texUri)), RC_NULL);
...
static int generateMaterialDefForFlatTexture(texture_t* tex, void* paramaters)
{
...
static int generateMaterialDefForSpriteTexture(texture_t* tex, void* paramaters)
{
...
{
    Textures_Iterate(TN_TEXTURES, generateMaterialDefForPatchCompositeTexture);
    Textures_Iterate(TN_FLATS,    generateMaterialDefForFlatTexture);
    Textures_Iterate(TN_SPRITES,  generateMaterialDefForSpriteTexture);
}
