...
void Def_GenerateAutoMaterials(void)
{
    ...
    for(i = 0; i < patchCompositeCount; ++i)
    {
        ...
        mat->id = Uri_Construct2(Str_Text(&pcomTex->name), RC_NULL);
    ...
    for(i = 0; i < flatTextureCount; ++i)
    {
        ...
        mat->id = Uri_Construct2(Str_Text(&flatTex->name), RC_NULL);
    ...
    for(i = 0; i < spriteTextureCount; ++i)
    {
        ...
        mat->id = Uri_Construct2(Str_Text(&sprTex->name), RC_NULL);
