...
#define ORIGINY (0)
    ...
    gemXOffset = (w - pGemInfo.width) * healthPos;

    if(gemXOffset > 0)
    {   // Left chain section.
        float cw = gemXOffset / pChainInfo.width;
    ...
    {   // Right chain section.
        float cw = (w - gemXOffset - pGemInfo.width) / pChainInfo.width;
