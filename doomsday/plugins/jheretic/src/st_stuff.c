...
#define ORIGINY (-ST_HEIGHT)
    ...
    WI_DrawPatch3(kslt->patchId, Hu_ChoosePatchReplacement(kslt->patchId), loc->x, loc->y, ALIGN_TOPLEFT, 0, 0);
...
#define Y                   (ORIGINY+ST_AMMOICONY)
    ...
    WI_DrawPatch3(icon->patchId, Hu_ChoosePatchReplacement(icon->patchId), X, Y, ALIGN_TOPLEFT, 0, 0);
