...
#define Y                   (ORIGINY+ST_MANAAICONY)
    ...
    if(icon->iconIdx >= 0)
    {
        ...
        WI_DrawPatch2(patchId, Hu_ChoosePatchReplacement(patchId), X, Y, ALIGN_TOPLEFT, 0, 0);
...
void BlueManaIcon_Drawer(uiwidget_t* obj, int x, int y)
{
    ...
    if(icon->iconIdx >= 0)
    {
        ...
        WI_DrawPatch2(patchId, Hu_ChoosePatchReplacement(patchId), 0, 0, ALIGN_TOPLEFT, 0, 0);
