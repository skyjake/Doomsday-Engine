...
#define GAME_VERSION_TEXT   "1.3.8"
#define GAME_VERSION_TEXTLONG GAME_VERSION_TEXT " " __DATE__ " (" JHEXEN_VER_ID ")"
#define GAME_VERSION_NUMBER 1,3,8,0 // For WIN32 version info.
