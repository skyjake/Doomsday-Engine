...
#ifndef __WOLFTC_CONTROLS__
#define __WOLFTC_CONTROLS__
...
static const MenuItem_t ControlsItems[] = {
    ...
    {ITT_EFUNC, 0, "KNIFE/CHAINSAW :", SCControlConfig, 51},
    {ITT_EFUNC, 0, "KNIFE :", SCControlConfig, A_WEAPON1},
    {ITT_EFUNC, 0, "CHAINSAW :", SCControlConfig, A_WEAPON8},
    {ITT_EFUNC, 0, "PISTOL :", SCControlConfig, A_WEAPON2},
    {ITT_EFUNC, 0, "FLAMETHROWER/MACHINEGUN :", SCControlConfig, 52},
    {ITT_EFUNC, 0, "MACHINEGUN :", SCControlConfig, A_WEAPON3},
    {ITT_EFUNC, 0, "FLAMETHROWER :", SCControlConfig, A_WEAPON9},
    {ITT_EFUNC, 0, "CHAINGUN :", SCControlConfig, A_WEAPON4},
    {ITT_EFUNC, 0, "ROCKET LAUNCHER :", SCControlConfig, A_WEAPON5},
    {ITT_EFUNC, 0, "????? :", SCControlConfig, A_WEAPON6},
    {ITT_EFUNC, 0, "????? :", SCControlConfig, A_WEAPON7},
