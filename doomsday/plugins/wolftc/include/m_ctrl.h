...
static const menuobject_t ControlsItems[] = {
    ...
    {MOT_TEXT, ITT_EFUNC, 0, "KNIFE/CHAINSAW :", SCControlConfig, 51},
    {MOT_TEXT, ITT_EFUNC, 0, "KNIFE :", SCControlConfig, A_WEAPON1},
    {MOT_TEXT, ITT_EFUNC, 0, "CHAINSAW :", SCControlConfig, A_WEAPON8},
    {MOT_TEXT, ITT_EFUNC, 0, "PISTOL :", SCControlConfig, A_WEAPON2},
    {MOT_TEXT, ITT_EFUNC, 0, "FLAMETHROWER/MACHINEGUN :", SCControlConfig, 52},
    {MOT_TEXT, ITT_EFUNC, 0, "MACHINEGUN :", SCControlConfig, A_WEAPON3},
    {MOT_TEXT, ITT_EFUNC, 0, "FLAMETHROWER :", SCControlConfig, A_WEAPON9},
    {MOT_TEXT, ITT_EFUNC, 0, "CHAINGUN :", SCControlConfig, A_WEAPON4},
    {MOT_TEXT, ITT_EFUNC, 0, "ROCKET LAUNCHER :", SCControlConfig, A_WEAPON5},
    {MOT_TEXT, ITT_EFUNC, 0, "????? :", SCControlConfig, A_WEAPON6},
    {MOT_TEXT, ITT_EFUNC, 0, "????? :", SCControlConfig, A_WEAPON7},
