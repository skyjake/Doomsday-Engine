...
// View/Refresh
    ...
    {"hud-title-noidsoft", 0, CVT_BYTE, &gs.cfg.hideAuthorIdSoft, 0, 1},
    {"hud-face-ouchfix", 0, CVT_BYTE, &PLRPROFILE.statusbar.fixOuchFace, 0, 1},
...
// Player
    ...
    {"player-camera-deathlookup", 0, CVT_BYTE, &PLRPROFILE.camera.deathLookUp, 0, 1},

// Compatibility options
    {"game-raiseghosts", 0, CVT_BYTE, &GAMERULES.raiseGhosts, 0, 1},
