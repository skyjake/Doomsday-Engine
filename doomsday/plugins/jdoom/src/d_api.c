...
DENG_API_EXCHANGE(
    ...
    DENG_GET_API(DE_API_CLIENT_latest, Client);
    DENG_GET_API(DE_API_CONSOLE_latest, Con);
    DENG_GET_API(DE_API_DEFINITIONS_latest, Def);
    DENG_GET_API(DE_API_FILE_SYSTEM_latest, F);
    DENG_GET_API(DE_API_FONT_RENDER_latest, FR);
    DENG_GET_API(DE_API_INFINE_latest, Infine);
    DENG_GET_API(DE_API_MATERIALS_latest, Material);
    DENG_GET_API(DE_API_MAP_latest, Map);
    DENG_GET_API(DE_API_MAP_EDIT_latest, MPE);
    DENG_GET_API(DE_API_PLAYER_latest, Player);
    DENG_GET_API(DE_API_PLUGIN_latest, Plug);
    DENG_GET_API(DE_API_SOUND_latest, S);
    DENG_GET_API(DE_API_SERVER_latest, Server);
