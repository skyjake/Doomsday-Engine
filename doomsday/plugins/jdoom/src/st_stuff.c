    ...
    int* drawnWidth, int* drawnHeight)
{
    ...
    M_DrawText3(buf, 0, 0, GF_FONTA, DTF_ALIGN_TOPLEFT|DTF_NO_EFFECTS);
    ...
    int* drawnWidth, int* drawnHeight)
{
    ...
    DGL_Color4f(cfg.hudColor[0], cfg.hudColor[1], cfg.hudColor[2], textAlpha);
    M_DrawText3(buf, w + 2, 0, GF_FONTB, DTF_ALIGN_BOTTOMLEFT|DTF_NO_EFFECTS);
    ...
    int* drawnWidth, int* drawnHeight)
{
    ...
    DGL_Color4f(cfg.hudColor[0], cfg.hudColor[1], cfg.hudColor[2], textAlpha);
    M_DrawText3(buf, 0, 0, GF_FONTB, DTF_ALIGN_BOTTOMRIGHT|DTF_NO_EFFECTS);
