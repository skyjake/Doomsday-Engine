...
static void shootSpecialLine(mobj_t *thing, linedef_t *line)
{
    ...
    case 24:
        // RAISE FLOOR
        EV_DoFloor(line, FT_RAISEFLOOR);
        P_ToggleSwitch((sidedef_t*) (sidedef_t*) P_GetPtrp(line, DMU_SIDEDEF0), SFX_NONE, false, 0);
    ...
    case 46:
        // OPEN DOOR
        EV_DoDoor(line, DT_OPEN);
        P_ToggleSwitch((sidedef_t*) (sidedef_t*) P_GetPtrp(line, DMU_SIDEDEF0), SFX_NONE, false, BUTTONTIME);
        break;
...
void P_UpdateSpecials(void)
{
    ...
    if(P_IterListSize(linespecials))
    {
        ...
        while((line = (linedef_t*) P_IterListIterator(linespecials)) != NULL)
        {
            ...
            case 48:
            case 85:
                side = (sidedef_t*) (sidedef_t*) P_GetPtrp(line, DMU_SIDEDEF0);
                if(xline->special == 85)
                    offset = -1;
                else
                    offset = 1;
...
boolean P_UseSpecialLine2(mobj_t* mo, linedef_t* line, int side)
{
    ...
    case 9:
        ...
        if(EV_DoDonut(line))
        {
            P_ToggleSwitch((sidedef_t*) P_GetPtrp(line, DMU_SIDEDEF0), SFX_NONE, false, 0);
            xline->special = 0;
        }
        break;
    ...
    case 11:
        ...
        P_ToggleSwitch((sidedef_t*) P_GetPtrp(line, DMU_SIDEDEF0), SFX_SWTCHX, false, 0);
        xline->special = 0;
        G_LeaveMap(G_GetMapNumber(gameEpisode, gameMap), 0, false);
        break;
    ...
    case 42:
        // Close Door.
        if(EV_DoDoor(line, DT_CLOSE))
            P_ToggleSwitch((sidedef_t*) P_GetPtrp(line, DMU_SIDEDEF0), SFX_NONE, false, BUTTONTIME);
        break;
