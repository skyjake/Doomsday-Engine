    ...
    int* drawnWidth, int* drawnHeight)
{
    ...
    *drawnHeight = 0;
    ...
    for(i = 0; i < numVisible; ++i)
    {
        ...
        GL_DrawText(msg->text, 0, y, GF_FONTA, textFlags, 0, col[CR], col[CG], col[CB], col[CA], 0, false);
    ...
    int* drawnWidth, int* drawnHeight)
{
    ...
    textFlags = DTF_ALIGN_TOP|DTF_NO_EFFECTS | ((cfg.msgAlign == 0)? DTF_ALIGN_LEFT : (cfg.msgAlign == 2)? DTF_ALIGN_RIGHT : 0);
    GL_DrawText(str, xOffset, 0, GF_FONTA, textFlags, 0, cfg.hudColor[CR], cfg.hudColor[CG], cfg.hudColor[CB], textAlpha, 0, false);
