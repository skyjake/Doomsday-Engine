...
static int PTR_PuzzleItemTraverse(Intercept const *icpt, void *context)
{
    ...
    case ICPT_LINE: {
        ...
        Game_ACScriptInterpreter_StartScript(xline->arg2, 0, &xline->arg3, parm.useMobj, icpt->line, 0);
        xline->special = 0;
    ...
    case ICPT_MOBJ:
        ...
        Game_ACScriptInterpreter_StartScript(icpt->mobj->args[1], 0, &icpt->mobj->args[2], parm.useMobj, NULL, 0);
        icpt->mobj->special = 0;
