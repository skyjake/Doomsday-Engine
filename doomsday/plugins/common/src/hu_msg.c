...
static void drawMessage(void)
{
    ...
    while(*p)
    {
        ...
        *p = 0;
        ...
        M_DrawText4(string, x, y, GF_FONTA, 0, cfg.menuColor2[0], cfg.menuColor2[1], cfg.menuColor2[2], 1);
    ...
    case MSG_ANYKEY:
        ...
        M_DrawText4(PRESSKEY, x, y, GF_FONTA, 0, cfg.menuColor2[0], cfg.menuColor2[1], cfg.menuColor2[2], 1);
        break;

    case MSG_YESNO:
        x = 160 - M_TextWidth(yesNoMessage, GF_FONTA) / 2;
        M_DrawText4(yesNoMessage, x, y, GF_FONTA, 0, cfg.menuColor2[0], cfg.menuColor2[1], cfg.menuColor2[2], 1);
        break;
