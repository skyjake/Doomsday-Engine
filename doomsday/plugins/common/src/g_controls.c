...
DEFCC( CCmdDefaultGameBinds )
{
    ...
    const char* binds[] = {
        ...
        "bindcontrol walk key-up-staged",
        "bindcontrol walk key-w-staged",
        "bindcontrol walk key-down-staged-inverse",
        "bindcontrol walk key-s-staged-inverse",
        "bindcontrol sidestep key-period-staged",
        "bindcontrol sidestep key-d-staged",
        "bindcontrol sidestep key-comma-staged-inverse",
        "bindcontrol sidestep key-a-staged-inverse",
