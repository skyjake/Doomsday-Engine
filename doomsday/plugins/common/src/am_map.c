...
mn_object_t AutomapMenuObjects[] = {
    ...
    { MN_SLIDER,    0,  0,              "",         GF_FONTA, MENU_COLOR, 0, MNSlider_Drawer, MNSlider_Dimensions, Hu_MenuCvarSlider, &sld_map_lineopacity },
    { MN_TEXT,      0,  0,              "HUD Display", GF_FONTA, MENU_COLOR, 0, MNText_Drawer, MNText_Dimensions },
    { MN_LISTINLINE, 0, 0,              "",         GF_FONTA, MENU_COLOR3, 0, MNListInline_Drawer, MNListInline_Dimensions, Hu_MenuCvarList, &lst_map_statusbar },
    { MN_TEXT,      0,  0,              "Door Colors", GF_FONTA, MENU_COLOR, 0, MNText_Drawer, MNText_Dimensions },
    { MN_BUTTON2,   0,  0,              "map-door-colors", GF_FONTA, MENU_COLOR3, 0, MNButton_Drawer, MNButton_Dimensions, Hu_MenuCvarButton },
    { MN_TEXT,      0,  0,              "Door Glow", GF_FONTA, MENU_COLOR, 0, MNText_Drawer, MNText_Dimensions },
    { MN_SLIDER,    0,  0,              "",         GF_FONTA, MENU_COLOR, 0, MNSlider_Drawer, MNSlider_Dimensions, Hu_MenuCvarSlider, &sld_map_doorglow },
