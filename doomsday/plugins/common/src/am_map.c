...
mn_object_t AutomapMenuObjects[] = {
    ...
    { MN_SLIDER,    0,  0,              "",         MENU_FONT1, MENU_COLOR1, 0, MNSlider_Dimensions, MNSlider_Drawer, Hu_MenuCvarSlider, MNSlider_CommandResponder, NULL, NULL, &sld_map_opacity },
    ...
    { MN_COLORBOX,  0,  MNF_INACTIVE,   "",                    MENU_FONT1, MENU_COLOR1, 0, MNColorBox_Dimensions, MNColorBox_Drawer, Hu_MenuActivateColorWidget, MNColorBox_CommandResponder, NULL, NULL, &cbox_map_line_floor_color },
    { MN_TEXT,      0,  0,              "Ceiling Height Change", MENU_FONT1, MENU_COLOR1, 0, MNText_Dimensions, MNText_Drawer },
    { MN_COLORBOX,  0,  MNF_INACTIVE,   "",                      MENU_FONT1, MENU_COLOR1, 0, MNColorBox_Dimensions, MNColorBox_Drawer, Hu_MenuActivateColorWidget, MNColorBox_CommandResponder, NULL, NULL, &cbox_map_line_ceiling_color },
    { MN_TEXT,      0,  0,              "Unseen",   MENU_FONT1, MENU_COLOR1, 0, MNText_Dimensions, MNText_Drawer },
    { MN_COLORBOX,  0,  MNF_INACTIVE,   "",         MENU_FONT1, MENU_COLOR1, 0, MNColorBox_Dimensions, MNColorBox_Drawer, Hu_MenuActivateColorWidget, MNColorBox_CommandResponder, NULL, NULL, &cbox_map_line_unseen_color },
    { MN_TEXT,      0,  0,              "Thing",    MENU_FONT1, MENU_COLOR1, 0, MNText_Dimensions, MNText_Drawer },
    { MN_COLORBOX,  0,  MNF_INACTIVE,   "",         MENU_FONT1, MENU_COLOR1, 0, MNColorBox_Dimensions, MNColorBox_Drawer, Hu_MenuActivateColorWidget, MNColorBox_CommandResponder, NULL, NULL, &cbox_map_mobj_color },
    { MN_TEXT,      0,  0,              "Background", MENU_FONT1, MENU_COLOR1, 0, MNText_Dimensions, MNText_Drawer },
    { MN_COLORBOX,  0,  MNF_INACTIVE,   "",           MENU_FONT1, MENU_COLOR1, 0, MNColorBox_Dimensions, MNColorBox_Drawer, Hu_MenuActivateColorWidget, MNColorBox_CommandResponder, NULL, NULL, &cbox_map_background_color },
    { MN_NONE }
};
