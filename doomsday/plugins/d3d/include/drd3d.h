...
extern          "C" {
    ...
    void            DG_Show(void);
    int             DG_Grab(int x, int y, int width, int height, int format,
                            void *buffer);
    ...
    void            DG_Color4ub(DGLubyte r, DGLubyte g, DGLubyte b,
                                DGLubyte a);
    ...
    void            DG_Perspective(float fovy, float aspect, float zNear,
                                   float zFar);
