...
#define STARTUPPK3      PLUGIN_NAMETEXT2 ".pk3"
    ...
    DD_AddGameResource(GID(doom64), FC_PACKAGE, FF_STARTUP, STARTUPPK3, 0);
    DD_AddGameResource(GID(doom64), FC_PACKAGE, FF_STARTUP, "doom64.wad", "MAP01;MAP020;MAP38;F_SUCK");
