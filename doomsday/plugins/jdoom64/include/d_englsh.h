...
#define GOTHELLBONUS        GET_TXT(TXT_GOTHELLBONUS) // jd64
...
#define OUCAST1TEXT         GET_TXT(TXT_OUCAST1TEXT) // jd64
#define OUCAST2TEXT         GET_TXT(TXT_OUCAST2TEXT) // jd64
...
#define CC_NHEAD            GET_TXT(TXT_CC_NHEAD) // jd64
