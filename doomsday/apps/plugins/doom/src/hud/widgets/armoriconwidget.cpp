...
guidata_armoricon_t::guidata_armoricon_t(dint player)
...
void guidata_armoricon_t::tick(timespan_t /*elapsed*/)
{
    ...
    _sprite = (plr->armorType == 2 ? SPR_ARM2 : SPR_ARM1);
}
...
void guidata_armoricon_t::draw(Vector2i const &offset) const
{
    ...
    GUI_DrawSprite(_sprite, 0, 0, HOT_TLEFT, 1, iconOpacity, false, nullptr, nullptr);
...
void guidata_armoricon_t::updateGeometry()
{
    ...
    Size2Raw iconSize;
    GUI_SpriteSize(_sprite, 1, &iconSize.width, &iconSize.height);
