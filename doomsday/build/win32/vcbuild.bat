...
IF NOT EXIST Include\dd_maptypes.h GOTO DMT
IF NOT EXIST Include\p_maptypes.h GOTO DMT
...
:DMT
CALL vcbuild script "Scripts/makedmt.py <Include/mapdata.hs"
MOVE /Y dd_maptypes.h Include\
MOVE /Y p_maptypes.h Include\
GOTO DONE
