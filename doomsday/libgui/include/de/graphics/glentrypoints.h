...
LIBGUI_EXTERN_C PFNGLBINDVERTEXARRAYPROC          glBindVertexArray;
LIBGUI_EXTERN_C PFNGLBLENDEQUATIONPROC            glBlendEquation;
LIBGUI_EXTERN_C PFNGLBLENDFUNCSEPARATEPROC        glBlendFuncSeparate;
LIBGUI_EXTERN_C PFNGLBLITFRAMEBUFFERPROC          glBlitFramebuffer;
...
LIBGUI_EXTERN_C PFNGLDELETEVERTEXARRAYSPROC       glDeleteVertexArrays;
...
LIBGUI_EXTERN_C PFNGLGENVERTEXARRAYSPROC          glGenVertexArrays;
...
LIBGUI_EXTERN_C PFNGLGETSTRINGIPROC               glGetStringi;
...
LIBGUI_EXTERN_C PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC glRenderbufferStorageMultisample;
...
LIBGUI_EXTERN_C PFNGLUNIFORM3FVPROC               glUniform3fv;
