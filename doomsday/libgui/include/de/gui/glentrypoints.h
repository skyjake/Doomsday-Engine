...
#ifdef WIN32
LIBGUI_EXTERN_C PFNWGLGETEXTENSIONSSTRINGARBPROC  wglGetExtensionsStringARB;
#endif
...
LIBGUI_EXTERN_C PFNGLFRAMEBUFFERRENDERBUFFERMULTISAMPLEEXTPROC  glFramebufferRenderbufferMultisampleEXT;
