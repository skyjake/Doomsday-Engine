...
void P_PtcInitForMap(void)
{
    ...
    pgLinks = (pglink_t**) Z_Malloc(sizeof(pglink_t *) * numSectors, PU_MAP, 0);
    ...
    pgStore = (pglink_t*) Z_Malloc(sizeof(pglink_t) * pgMax, PU_MAP, 0);
    pgCursor = 0;
...
static void P_InitParticleGen(ptcgen_t* gen, const ded_ptcgen_t* def)
{
    ...
    gen->stages = (ptcstage_t*) Z_Calloc(sizeof(ptcstage_t) * def->stageCount.num,
                           PU_MAP, 0);
