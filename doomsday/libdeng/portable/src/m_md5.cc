...
/*
 * md5.c: MD5 Hash Generator
 *
 * This code has been adapted from the Linux kernel sources (crypto/md5.c).
 */
...
{
    struct md5_ctx *mctx = (md5_ctx*) ctx;
...
void md5_final(void *ctx, u8 *out)
{
    ...
    *p++ = 0x80;
    ...
    le32_to_cpu_array(mctx->block, (sizeof(mctx->block) - 8) / sizeof(u32));
