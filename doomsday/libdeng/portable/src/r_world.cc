...
{
    surfacelistnode_t*      node = (surfacelistnode_t*) Z_Calloc(sizeof(*node), PU_STATIC, 0);
    return node;
}
...
plane_t* R_NewPlaneForSector(sector_t* sec)
{
    ...
    plane = (plane_t*) Z_Malloc(sizeof(plane_t), PU_MAP, 0);
    ...
    while(*ssecPtr)
    {
        ...
        newList = (biassurface_t**) Z_Calloc(sec->planeCount * sizeof(biassurface_t*),
                           PU_MAP, NULL);
...
void R_DestroyPlaneOfSector(uint id, sector_t* sec)
{
    ...
    if(sec->planeCount > 1)
    {
        ...
        newList = (plane_t**) Z_Malloc(sizeof(plane_t**) * sec->planeCount, PU_MAP, 0);
