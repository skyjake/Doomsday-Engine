...
static boolean C_DECL clockwiseLeaf(binarytree_t *tree, void *data)
{
    ...
    {   // obj is a leaf.
        ...
        renumberLeafHEdges(leaf, (unsigned int*) data);
...
{
    return (bspleafdata_t*) M_Malloc(sizeof(bspleafdata_t));
}
...
Con_Message("BuildNodes: Partition %p (%1.0f,%1.0f) -> (%1.0f,%1.0f).\n",
    ...
    node = (bspnodedata_t*) M_Calloc(sizeof(bspnodedata_t));
