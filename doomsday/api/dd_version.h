...
#define DOOMSDAY_VERSION_BASE   "1.15.6"
#define DOOMSDAY_VERSION_NUMBER 1,15,6,0 // For WIN32 version info.
 ...
 */
#define DOOMSDAY_COPYRIGHT      "2003-2015, " DENGPROJECT_NICEAUTHOR
