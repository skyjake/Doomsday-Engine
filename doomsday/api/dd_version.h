...
#define DOOMSDAY_VERSION_BASE   "1.15.9"
#define DOOMSDAY_VERSION_NUMBER 1,15,9,0 // For WIN32 version info.
 ...
 */
#define DOOMSDAY_COPYRIGHT      "2003-2016, " DENGPROJECT_NICEAUTHOR
