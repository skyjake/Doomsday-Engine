...
del %FILE%.exe
rar a %FILE% %SRC%\Kicks.exe %SRC%\*.cfg %SRC%\*.ksl %SRC%\Doc\*.* %SRC%\Bin\*.* %SRC%\Defs\*.ded %SRC%\Data\*.* %SRC%\Data\Fonts %SRC%\Data\Graphics %SRC%\Data\KeyMaps -xBin\jDoom.dll -x*heretic*.* -x*hexen*.*
