...
[Setup]
OutputBaseFilename=deng-1.9.0-beta6.7-setup
VersionInfoVersion=1.9.0.6
AppName=Doomsday Engine
AppVerName=Doomsday Engine 1.9.0-beta6.7
...
AppCopyright=Copyright (C) 2003-2009 Deng Team
...
WizardImageFile=installerbg.bmp

[Components]
Name: "Engine"; Description: "Doomsday Engine"; Types: full compact custom; Flags: fixed checkablealone;
Name: "Engine\jDoom"; Description: "jDoom game plugin (DOOM/Ultimate DOOM/DOOMII/Final DOOM)"; Types: full compact
Name: "Engine\jHeretic"; Description: "jHeretic game plugin (Heretic/Heretic: Shadow of the Serpent Riders)"; Types: full compact
Name: "Engine\jHexen"; Description: "jHexen game plugin (Hexen/Hexen: Death Kings of the Dark Citadel)"; Types: full compact
Name: "Launcher"; Description: "Doomsday Engine launcher (front end)"; Types: full
...
; Binaries
Source: "Bin\Release\Doomsday.exe"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: Engine
Source: "Bin\Release\ds*.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: Engine
Source: "Bin\Release\dp*.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: Engine
Source: "Bin\Release\jDoom.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: Engine\jDoom
Source: "Bin\Release\jHeretic.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: Engine\jHeretic
Source: "Bin\Release\jHexen.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: Engine\jHexen
...
Source: "..\..\engine\data\graphics\background.pcx"; DestDir: "{app}\data\graphics"; Components: Engine
